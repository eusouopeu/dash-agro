...
export const formulas: Formula[] = [
  ...
  {
    key: 'alavancagem',
    nome: 'Índice de Alavancagem Financeira',
...
export const formulasParciais: Formula[] = [
  {
    ...
    denominador: 'Receita Líquida',
    unidade: '%',
    leitura: 'Quanto sobra da receita depois de juros, impostos e todas as despesas — o que efetivamente sobrou no exercício. Hoje só a BRF tem essa linha extraída.',
    melhor: 'maior',
  },
  {
    key: 'roe',
    ...
    sigla: 'ROE',
    numerador: 'Resultado Líquido',
    denominador: 'Patrimônio Líquido',
    unidade: '%',
    leitura: 'Quanto rendeu o capital próprio — o que sobrou para quem é dono do negócio (acionista ou cooperado). Hoje só a BRF tem essa linha extraída.',
    melhor: 'maior',
  },
  {
    key: 'roa',
    ...
    denominador: 'Ativo Total',
    unidade: '%',
    leitura: 'Quanto rendeu todo o ativo da empresa, incluindo a parte financiada por terceiros. Hoje só a BRF tem essa linha extraída.',
    melhor: 'maior',
  },
  {
    key: 'capexSobreReceita',
    nome: 'Intensidade do CAPEX',
