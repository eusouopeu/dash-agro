...
export const referencias: ReferenciaABNT[] = [
  // --- Fonte primária dos dados da BRF ------------------------------------
  {
    ...
    acesso: ACESSO,
    nota: 'Repositório de onde foram extraídos os formulários DFP da BRF listados a seguir. O sufixo numérico de cada arquivo é o ano do próprio exercício (DT_REFER), não o ano em que a DFP foi arquivada — por isso o exercício de 2025, arquivado em 18/03/2026, está em dfp_cia_aberta_2025.zip.',
    grupo: 'brf',
  },
  {
    id: 'brf-2021',
    ...
    editora: 'BRF',
    ano: '2022',
    complemento: 'Demonstrações consolidadas. CD_CVM 016292; CNPJ 01.838.723/0001-27. Arquivada em 22 fev. 2022',
  ...
  },
  {
    ...
    editora: 'BRF',
    ano: '2023',
    complemento: 'Demonstrações consolidadas. CD_CVM 016292. Arquivada em 28 fev. 2023',
  ...
  },
  {
    ...
    editora: 'BRF',
    ano: '2024',
    complemento: 'Demonstrações consolidadas. CD_CVM 016292. Arquivada em 26 fev. 2024',
  ...
  },
  {
    ...
    editora: 'BRF',
    ano: '2025',
    complemento: 'Demonstrações consolidadas. CD_CVM 016292. Arquivada em 26 fev. 2025',
  ...
  },
  {
    ...
    autor: 'BRF S.A.',
    titulo: 'Demonstrações financeiras padronizadas (DFP)',
    subtitulo: 'exercício social encerrado em 31 de dezembro de 2025',
    local: 'Itajaí, SC',
    editora: 'BRF',
    ano: '2026',
    complemento: 'Demonstrações consolidadas. CD_CVM 016292. Arquivada em 18 mar. 2026, já sob a estrutura combinada com a Marfrig',
